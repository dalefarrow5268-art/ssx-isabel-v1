...
- **Reggie Rules** — identifies project working hours, labor classifications, wage rules, holidays, weekends, night work, deliveries, inspections, shutdowns, permits and AHJ requirements; preserves evidence; detects conflicts; and opens blocking review items.
...
- D1 project, document, extraction, requirements, review-queue and employee-status audit tables.
...
Penny Plancheck, Parker Picker, Esther Estimates, Sally Sequence, Wendy Weatherwise, Duncan Duration, Quincy Quality and Piper Presentations.
